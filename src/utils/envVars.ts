...
export const CUSTOM_NETWORK             = Number(process.env.REACT_APP_CUSTOM_NETWORK);
...
export const MIN_DEPOSIT_ETHER          = Number(process.env.REACT_APP_MIN_DEPOSIT_AMOUNT) || 1;
